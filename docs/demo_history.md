...
The final product demo is shown in the main `README.md`.

---

## Phase 1: Face Detection

Phase 1 validated the OpenCV and MediaPipe face detection pipeline.
...
Phase 2 added a FER2013-trained expression recognition model.

Main features:

- FER2013 dataset loader.
- ResNet18 and MobileNet transfer learning experiments.
- Expression prediction from detected face crops.
